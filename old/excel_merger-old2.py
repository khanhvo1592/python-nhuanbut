...
class ExcelMerger:
    ...
    def merge_sheets(self, input_file, output_file):
        ...
        if "data" in target_wb.sheetnames:
            ...
            # Đổi tên sheet "Sheet1" thành "data" nếu "data" chưa tồn tại
            target_ws = target_wb["Sheet1"]
            target_ws.title = "data"  # Cập nhật tên sheet

        # Định nghĩa thứ tự mới của cột dựa trên chỉ số cột từ file nguồn
        # Ví dụ: cột "Thời gian" ở chỉ số 0, "Họ và tên" ở chỉ số 1, v.v...
        new_order = [1, 2, 3, 4, 5]
